...
<nav class="  fixed-top ortala" id="mainNav" style="position: relative;bottom: 100px;">
            ...
            <div class="d-flex justify-content-center form_container">
                <form>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="" class="form-control input_pass" id="getAdress" value="" placeholder="Adres">
                    </div>

                    <div class="input-group mb-3">

                        <input type="text" name="" class="form-control input_pass" id="getIlce" value="" placeholder="İlçe">
                    </div>

                    <div class="input-group mb-3">

                        <input type="text" name="" class="form-control input_pass" id="getIl" value="" placeholder="İl">
                    </div>



                    <div class="d-flex justify-content-center mt-3 login_container">
                        <button type="button" name="button" id="signUp" class="btn login_btn">Kayıt</button>
                    </div>
                </form>
            </div>
...
<script src="/register/parkingOwnerRegister/js/parkingOwnerSignUp.js"></script>
</html>